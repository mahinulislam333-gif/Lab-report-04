...
The objective of this experiment is to understand and implement the Minimax algorithm with Alpha-Beta Pruning and analyze its efficiency. 
1.To implement Minimax and Alpha-Beta Pruning using Python.
2.To generate a binary game tree with random leaf node values.
3.To compare the number of nodes evaluated in both algorithms.
4.To calculate the efficiency improvement achieved by Alpha-Beta Pruning.
